...
SUMMARY = (
    ...
    "FB2/CBZ), plain text, Markdown, HTML, images, and code -- no format "
    "tax.\n\n"
    ...
    "Obsidian's CEO) open palette (stephango.com/flexoki) -- a nod to his "
    "\"File Over App\" principle (stephango.com/file-over-app): your data "
    "should outlive any one piece of software. Same reason Slate works "
    "directly on real PDFs and plain files, not a project-specific "
    "format.\n\n"
